...
Le code ci-dessous permet de calculer les paramètre à entrer dans [ce calculateur Demsos](https://www.desmos.com/calculator/uzwkckigsv){target="_blank"}.
...
En sortie, le code affiche les quatre constantes $A$, $B$, $C$ et $D$ à renseigner au [calculateur Desmos](https://www.desmos.com/calculator/uzwkckigsv){target="_blank"}, ainsi que:
...
Dans le [calculateur Desmos](https://www.desmos.com/calculator/uzwkckigsv){target="_blank"} :
